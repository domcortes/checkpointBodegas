	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" action="/panel/php/goes/entry.php">
					<span class="login100-form-title">
						Inicio de sesión en Intranet Chelech
					</span>

					<div class="wrap-input100 validate-input" data-validate = "Debe ingresar un usuario válido">
