    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form method="post" id="formReport" name="formReport">
              <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select id="year" name="year" class="form-control select2" style="width: 100%;">
                      ...
                      while($anio<=2030){
                      ?>
                      <option <?php echo $anio; ?>><?php echo $anio; ?></option>
                      <?php
                          $anio++;
                        }
                      ?>
                  ...
                  <tbody>
                    ...
                    $tsql= "SELECT DISTINCT
                      ...
                      WHERE
                        ...
                        AND (dbo.MAEVEN.FEVE BETWEEN '20201101' AND '20201201')
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="text-center"><?php echo date_format($row['Fecha'],'d-m-Y'); ?></td>
                        <td class="text-center"><?php echo ($row['Estado'] . PHP_EOL); ?></td>
                        <td class="text-center"><?php echo date_format($row['FVencimiento'],'d-m-Y'); ?></td>
