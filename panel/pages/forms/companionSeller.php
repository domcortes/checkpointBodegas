...
<head>
  ...
  <title>Checkpoint Chelech - Acompañante trabajador</title>
      ...
      <div class="container-fluid">
        <div class="row mb-6">
          <div class="col-lg-12 col-mb-6">
            <h1>INGRESO DE ACOMPAÑANTES DEL DEL VENDEDOR</h1>
          </div>
          <div class="col-sm-6">
          </div>
        </div>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">En esta sección usted ingresa a las personas que <strong>acompañan</strong> al vendedor para <strong>una posible compra</strong></h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <form method="post" action="../../php/clases/procesos/addingCompanionSeller.php" onsubmit="return enviar();">
              <div class="row">
                <div class="col-md-6">
        ...
        <div class="card card-default">
          <div class="card-header">
            <?php
            $entry = new metodos();
            $queryEntry = "SELECT * from personas where id_ingreso = $entrada and tipoIngreso = 'vendedor'";
            $descriptions = $entry->mostrarDatos($queryEntry);
            ?>
            <h3 class="card-title">Listado de acompañantes de <strong><?php echo strtoupper($descriptions[0]['nombrePersona'])?>.</strong></h1>
          </div>
          <div class="card-body">
