...
//tabla presentacion cliente
  ...
  $pdf->Cell(150,6,'0527769-8',1,0,'L',0);
//-fin tabla presentacion cliente
  $pdf->Ln(15);

//enviar a cliente
$to = "daniel@nekorp.com";
$from = "no-reply@chelech.cl";
$subject = "Estado de Cuenta Empresas Chelech";
$message = "<p>Por favor revisar adjunto</p>";
